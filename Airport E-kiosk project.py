...
mycon=sqltor.connect(host='localhost',database='ip',user='root',password='anushka@4002')
...
p.title("Passenger Trafic in Middle East's Cleanest Airports")
...
def SpiceJet():
    ...
    print("\nThe format of Booking Reference for Spice Jet is:: SJ900'ENTER your last and first name initials'")
...
ax.set_xlim(0, 2)
ax.set_ylim(0, 4)
arr_lena = mpimg.imread('C:/Users/anush/Downloads/ProhibitedItems.jpeg')
...
print("""\t\t\t\t+------------------------+
            |    Flight Information  |
                +------------------------+""") 
df=pd.read_csv("C:\\Users\\anush\\Downloads\\Flight_Information - Sheet3.csv")
print(df)
print()
flight=int(input("Enter the number from the above table that corressponds with your flight:"))
...
ax.set_xlim(0, 2)
ax.set_ylim(0, 4)
arr_lena = mpimg.imread('C:/Users/anush/Downloads/FlightSeat.jpeg')
...
def Economy():
         df1=pd.read_sql('select * from economy_class;',mycon)
         print(df1)
         print()
...
arr_lena = mpimg.imread('C:\\Users\\anush\\Downloads\\covidPrecautions.jpeg')

imagebox = OffsetImage(arr_lena, zoom=0.75)
